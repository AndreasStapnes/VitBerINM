...
rout = routine(f=(a,b,c), functionCallable=fun, tInit=0,tFinal=3e5, y0=qp0, ordinaryStepLen=1e-1,method="Kah",timeline=True, savePlaneCuts=True, nopythonExe=True, timelineJumps=300)
